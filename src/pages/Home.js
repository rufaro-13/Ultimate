    ...
    <div class="relative w-full bg-cover bg-center bg-no-repeat  bg-sky-50 bg-blend-multiply">
      ...
      />
            ...
            <div class="px-4 mx-auto max-w-screen-xl text-center pt-6 flex ">
                    <h4 class="md:mb-2 text-2xl font-extrabold tracking-tight leading-none text-darkbluetheme md:text-3xl lg:text-3xl">
                        We offer Activity Based Care and some of the activities we offer include the ones in the pictures below. <span className='text-blue-600'><Link to='/activities'>Learn More </Link></span>
                    </h4>
