...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_guj5iyh', 'template_r84qs1q', form.current, '6qo4_vtAGrselw6FA')
      .then((result) => {
  ...
  return (
    <div className='relative w-full bg-cover bg-center bg-no-repeat bg-contacts bg-slate-300 md:justify-center  bg-blend-multiply mb-5'>
...
{/* <Helmet>
        ...
        <section className='  text-center pt-6 py-4 lg:py-24'>
            <div class="px-auto mx-auto max-w-screen-xl t pt-4">

                <div class="lg:px-4 mx-auto max-w-screen-xl text-center pt-6  ">
                    <h4 class="mb-6 text-1xl font-extrabold tracking-tight leading-none text-darkbluetheme md:text-3xl lg:text-3xl">
                    Contacting Us
                    </h4>
                </div> 

                <div class="sm:flex sm:items-center sm:justify-center lg:mx-8 mt-4 px-5">
                ...
                <div className='md:mx-4 lg:flex'>
                  <div className='lg:w-full '> 
                    <div class=" grid lg:grid-cols-3../ lg:gap-5  md:grid-cols-3 md:gap-x-2 grid-col-1 px-2 md:px-2 pt-4 items-center sm:items-center sm:justify-center mx-4  lg:mx-2 mt-1">
                    
                     <div class="lg:px-1 px-4  col-span-1 max-w-max  md:w-1/2 sm:items-start sm:justify-start">

                        <IconContext.Provider value={{ color: '#ff0000', size: '40px', padding:'5px 2px' }}>
                            <a href="mailto:talk2us@ultimatestepsupport.co.uk"><div class="  sm:items-center sm:justify-center  mx-2 mt-5 mb-5">
                            
                            <FaEnvelopeOpenText class="sm:items-center sm:justify-center mx-1 my-6"/>
                            </div></a>
                          </IconContext.Provider>
                          <div class="  sm:items-center sm:justify-center  mt-1">
                            <p class=" text-sm font-normal">
                            <div><span class=" text-2xl font-bold"><a href="mailto:talk2us@ultimatestepsupport.co.uk" className="block py-2 pl-1 pr-4 underline text-darkbluetheme rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-darkbluetheme dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Email Us</a></span></div>
                            talk2us@ultimatestepsupport.co.uk
                    ...
                    <div class="lg:px-1 px-4  col-span-1 max-w-max  md:w-1/2 sm:items-start sm:justify-start">
                        ...
                        <IconContext.Provider value={{ color: '#ff0000', size: '40px', padding:'5px 2px' }}>
                            <a href="mailto:admin@ultimatestepsupport.co.uk"><div class="  sm:items-center sm:justify-center  mx-2 mt-5 mb-5">
                          ...
                          <div class="  sm:items-center sm:justify-center  mt-1">
                            <p class=" text-sm font-normal">
                            <div><span class=" text-2xl font-bold"><a href="mailto:admin@ultimatestepsupport.co.uk" className="block py-2 pl-1 pr-4 underline text-darkbluetheme rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-darkbluetheme dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Email Us</a></span></div>
                            admin@ultimatestepsupport.co.uk

                            </p>
                          </div>
                    </div> 

                    <div class="lg:px-1 px-2  col-span-1 max-w-max  md:w-1/2 sm:items-start sm:justify-start">

                          <IconContext.Provider value={{ color: '#231f32', size: '40px', padding:'5px 2px' }}>
                            <a href="tel:+44 7400 180829"><div class="  sm:items-center sm:justify-center   mt-5 mb-5">
                              <FaMobileScreenButton class="sm:items-center sm:justify-center  my-6"/>
                            </div></a>
                          </IconContext.Provider>
                          <div class="  sm:items-center sm:justify-center   mt-1">
                            <p class=" text-sm font-normal">
                            <div><span class=" text-2xl font-bold  "><a href="tel:0795 419 2764" 
                    ...
                    <div class="lg:px-1 px-3  col-span-1 max-w-max  md:w-1/2 sm:items-start sm:justify-start">
                          ...
                          <IconContext.Provider value={{ color: '#ff0000', size: '40px', padding:'5px 2px' }}>
                            <a href="https://www.google.com/maps/dir/52.4271708,16.9250173/196+Western+Rd,+Leicester+LE3+0GB,+UK/@51.0426016,-2.6788128,5z"><div class="  sm:items-center sm:justify-center   mt-5 mb-5">
                              <FaLocationDot class="sm:items-center sm:justify-center  my-6"/>
                            </div></a>
                          </IconContext.Provider>
                          <div class="  sm:items-center sm:justify-start  mt-1">
                ...
                <div class="md:pt-5 lg:w-2/5 sm:w-screen">
                  ...
                  <div class="lg:px-0 px-2 pb-4  pt-5 mt-1 w-fit md:w-full sm:items-start sm:justify-start">
                  <form class="  max-w-max " ref={form} onSubmit={sendEmail}>
                    ...
                    <div class="mb-6 ">
                        ...
                        <input type="text" name="user_name" id="name"autocomplete="given-name" size="60" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[100%] lg:w-full py-2.5 px-2 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="example: John Smith" required/>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input icon={HiMail} type="email"name="user_email"autocomplete="email" id="email"size="60" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[100%] lg:w-full py-2.5 px-2 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example: name@email.com" required/>
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="tel"name="user_telephone"autocomplete="tel" id="telephone"size="60" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[100%] lg:w-full py-2.5 px-2 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example: 0798 125 4567" required/>
                    </div> 
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="message" name="message"rows="5"autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full lg:w-full p-2 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your message here....." required/>
                    </div>
